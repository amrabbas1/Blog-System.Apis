...
namespace BlogSystem.Repository.Data.Migrations
{
    ...
    [Migration("20250209205958_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogSystem.Core.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BlogSystem.Core.Models.BlogPost", b =>
                {
                    ...
                    b.HasOne("BlogSystem.Core.Models.Category", "Category")
                        .WithMany("BlogPosts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BlogSystem.Core.Models.User", null)
                        .WithMany()
